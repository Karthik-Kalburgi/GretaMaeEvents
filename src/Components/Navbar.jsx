...
import { NavLinkNav } from "react-router-dom";
    ...
    <div>
      ...
      <nav>
        <ul className=" justify-end gap-16 absolute top-0 right-1 mt-4 items-center font-bold md:flex hidden  ">
          <li className="hover:text-orange-600" NavLink to='/'>Home</li>
          <li className="hover:text-orange-600"  NavLink to='/about'>About Me</li>
          <li className="hover:text-orange-600"  NavLink to='/myportfolio'>My Portfolio</li>
          <li className="hover:text-orange-600"  NavLink to='/mytestimonial'>Testimonials</li>
          <li className="hover:text-orange-600"  NavLink to='/contact'>Contract</li>

          <button className=" flex border bg-black text-white px-7 rounded-2xl items-center justify-start gap-2 p-2">
            <span className="hover:text-blue-500" >Work With Me</span>
